...
window.onclick = function(event) {
	...
	// script.js
document.getElementById('downloadBtnx1').addEventListener('click', function() {
    // Specify the URL of the file to be downloaded
    const fileUrl = "https://modsfire.com/Jrp42CInB7s1ED3"; // Replace with the actual file URL
...
document.getElementById('downloadBtnx2').addEventListener('click', function() {
    // Specify the URL of the file to be downloaded
    const fileUrl = "https://modsfire.com/m84a8e0g8s3T1my"; // Replace with the actual file URL
...
document.getElementById('downloadBtn1').addEventListener('click', function() {
    // Specify the URL of the file to be downloaded
    const fileUrl = "https://modsfire.com/vl8Y2Nm12U49YDV"; // Replace with the actual file URL
